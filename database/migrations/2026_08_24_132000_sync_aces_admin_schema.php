...
return new class extends Migration
{
    ...
    {
        // Keep this migration idempotent so the ACES Training/Admin module can
        // be installed on a fresh database or on an existing ACES database.
    ...
    {
        // Schema sync migrations intentionally do not remove existing columns.
    }
