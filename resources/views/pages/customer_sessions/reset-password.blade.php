...
<div class="ao-training"><div class="ao-wrap" style="max-width:650px"><div class="ao-panel" style="padding:36px">
    <div class="ao-eyebrow">SECURE PASSWORD RESET</div><h1 class="ao-section-title mt-2">Choose a new password</h1><p class="ao-muted mt-2 mb-4">Use at least 8 characters. This reset link can only be used for the matching Training account.</p>
