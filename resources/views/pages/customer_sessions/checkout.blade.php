...
@section('title', 'Training Checkout | ACES Lacrosse')
...
<style>
:root{--ao-red:#611eb2;--ao-soft:#f4edfc;--ao-bg:#f7f6f9;--ao-border:#e4e0e9;--ao-muted:#666d79}.training-checkout-page{min-height:calc(100vh - 104px);background:var(--ao-bg);padding:24px 0 55px;font-family:'Roboto',Arial,sans-serif;color:#111}.training-checkout-shell{width:min(1230px,calc(100% - 24px));margin:0 auto}.training-checkout-grid{display:grid;grid-template-columns:minmax(0,1fr) 310px;gap:20px;align-items:stretch}.training-checkout-card{background:#fff;border:1px solid var(--ao-border);border-radius:26px;padding:20px;box-shadow:0 14px 30px rgba(48,27,65,.05)}.training-checkout-title{margin:0 0 16px;font-size:26px;font-weight:900;letter-spacing:-.04em}.training-checkout-columns{display:grid;grid-template-columns:1fr 1fr;gap:20px}.training-checkout-section{min-width:0}.training-checkout-section:first-child{padding-right:18px;border-right:1px solid #cfd3d8}.training-checkout-section-head{display:flex;align-items:center;justify-content:space-between;gap:14px;border-bottom:1px solid #dfe2e7;padding-bottom:12px;margin-bottom:13px}.training-checkout-section-head h3{margin:0;font-size:19px;font-weight:800}.training-checkout-section-head i{color:var(--ao-red)}.training-fields-2{display:grid;grid-template-columns:1fr 1fr;gap:12px}.training-fields-email{display:grid;grid-template-columns:1.4fr .7fr;gap:12px}.training-fields-address{display:grid;grid-template-columns:1.25fr .65fr .55fr;gap:12px}.training-fields-card{display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px}.training-field{margin-bottom:12px}.training-field label{display:block;margin-bottom:5px;font-size:10px;font-weight:900}.training-field label span{color:var(--ao-red)}.training-input,.training-select{width:100%;height:42px;border:1px solid #d7dbe1;border-radius:8px;background:#fff;padding:0 11px;font-size:12px;outline:none;transition:.18s}.training-input:focus,.training-select:focus{border-color:var(--ao-red);box-shadow:0 0 0 3px rgba(97,30,178,.08)}.training-error{display:block;margin-top:4px;color:#b42318;font-size:10px;font-weight:800}.training-checkout-summary{background:#fff;border:1px solid var(--ao-border);border-radius:26px;padding:20px;box-shadow:0 14px 30px rgba(48,27,65,.07);display:flex;flex-direction:column}.training-checkout-summary-head{display:flex;align-items:center;justify-content:space-between;gap:15px}.training-checkout-summary-head h2{margin:0;font-size:25px;font-weight:900}.training-checkout-summary-head i{color:var(--ao-red);font-size:19px}.training-summary-row{display:flex;justify-content:space-between;gap:14px;padding:8px 0;color:#5e6571;font-size:12px;font-weight:800}.training-summary-spacer{flex:1;min-height:90px}.training-summary-total-area{border-top:1px solid #dfe2e7;padding-top:17px}.training-summary-total{display:flex;justify-content:space-between;align-items:flex-end;gap:14px}.training-summary-total span{font-size:16px;font-weight:900}.training-summary-total strong{font-size:29px;color:var(--ao-red);font-weight:900}.training-pay-btn{width:100%;min-height:46px;border:0;border-radius:999px;margin-top:18px;background:var(--ao-red);color:#fff;font-size:12px;font-weight:900;box-shadow:0 12px 24px rgba(97,30,178,.24)}.training-pay-btn:hover{background:#4d168f}.training-checkout-alert{margin-bottom:15px;border-radius:14px;padding:12px 14px;font-size:12px;font-weight:800}.training-checkout-alert.error{background:#fff1f2;color:#b42318}.training-security{margin-top:12px;color:#69707b;font-size:10px;line-height:1.5}.training-security i{color:var(--ao-red)}@media(max-width:950px){.training-checkout-grid{grid-template-columns:1fr}.training-summary-spacer{min-height:0}.training-checkout-summary{min-height:auto}}@media(max-width:720px){.training-checkout-columns{grid-template-columns:1fr}.training-checkout-section:first-child{padding-right:0;border-right:0;border-bottom:1px solid #dfe2e7;padding-bottom:8px}.training-fields-2,.training-fields-email,.training-fields-address,.training-fields-card{grid-template-columns:1fr}.training-checkout-shell{width:min(100% - 16px,1230px)}.training-checkout-card,.training-checkout-summary{border-radius:20px;padding:16px}}
</style>
                ...
                <div class="training-checkout-card">
                    ...
                    <div class="training-checkout-columns">
                        ...
                        <section class="training-checkout-section">
                            ...
                            <p class="training-security"><i class="fa-solid fa-lock me-1"></i>Card number and CVV are sent to the payment gateway for this transaction and are not stored by ACES Lacrosse.</p>
                        </section>
                    </div>
                </div>
