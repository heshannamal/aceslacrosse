...
<head>
    ...
    <title>@yield('title', 'Training Dashboard | Alcatraz Outlaws')</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Archivo+Black&family=Raleway:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
    <style>
        :root{--ao-red:#f3282c;--ao-dark:#050505;--ao-soft:#fff0f0;--ao-border:rgba(0,0,0,.08);--ao-muted:#667085}
        *{box-sizing:border-box}body{margin:0;background:#f7f7f8;color:#080808;font-family:'Raleway',Arial,sans-serif}.ao-portal{min-height:100vh;display:flex}.ao-side{position:fixed;left:0;top:0;bottom:0;width:168px;z-index:100;background:radial-gradient(circle at top left,rgba(243,40,44,.26),transparent 34%),linear-gradient(180deg,#080808,#111 55%,#050505);color:#fff;border-right:1px solid rgba(255,255,255,.08);box-shadow:16px 0 45px rgba(0,0,0,.16)}.ao-side-logo{display:flex;height:64px;align-items:center;justify-content:center;border-bottom:1px solid rgba(255,255,255,.08);padding:9px}.ao-side-logo img{max-width:118px;max-height:50px;object-fit:contain}.ao-side-nav{padding:16px 10px}.ao-side-link{display:flex;align-items:center;gap:10px;min-height:43px;margin-bottom:8px;padding:0 13px;border-radius:14px;color:rgba(255,255,255,.7);text-decoration:none;font-size:12px;font-weight:900;transition:.18s}.ao-side-link i{width:19px;text-align:center;color:var(--ao-red)}.ao-side-link:hover{background:rgba(255,255,255,.08);color:#fff;transform:translateX(2px)}.ao-side-link.active{background:linear-gradient(135deg,var(--ao-red),#ff686b);color:#fff;box-shadow:0 12px 26px rgba(243,40,44,.28)}.ao-side-link.active i{color:#fff}.ao-main{width:calc(100% - 168px);margin-left:168px;min-height:100vh}.ao-top{position:sticky;top:0;z-index:90;height:58px;background:rgba(255,255,255,.95);backdrop-filter:blur(16px);border-bottom:1px solid var(--ao-border);box-shadow:0 8px 28px rgba(0,0,0,.04);display:flex;align-items:center;justify-content:flex-end;padding:0 18px;gap:12px}.ao-mobile-toggle{display:none;border:0;background:#050505;color:#fff;width:42px;height:42px;border-radius:13px}.ao-top-cart{position:relative;display:inline-flex;align-items:center;justify-content:center;width:42px;height:42px;border-radius:14px;background:#050505;color:#fff;text-decoration:none}.ao-top-cart:hover{background:var(--ao-red);color:#fff}.ao-top-count{position:absolute;right:-5px;top:-6px;min-width:20px;height:20px;padding:0 5px;border-radius:999px;background:var(--ao-red);border:2px solid #fff;font-size:10px;font-weight:900;display:flex;align-items:center;justify-content:center}.ao-user-trigger{display:flex;align-items:center;gap:9px;border:1px solid var(--ao-border);background:#fff;border-radius:999px;padding:5px 10px 5px 5px;text-decoration:none;color:#111;box-shadow:0 8px 22px rgba(0,0,0,.05)}.ao-avatar{width:36px;height:36px;border-radius:999px;object-fit:cover;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,var(--ao-red),#111);color:#fff;font-weight:900;border:2px solid #fff}.ao-user-name{font-size:12px;font-weight:900;max-width:150px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.ao-dropdown{border:0!important;border-radius:18px!important;padding:8px!important;box-shadow:0 20px 50px rgba(0,0,0,.14)!important}.ao-dropdown .dropdown-item{border-radius:12px;padding:10px 12px;font-size:12px;font-weight:800}.ao-dropdown .dropdown-item:hover{background:var(--ao-soft);color:var(--ao-red)}.ao-content{padding:18px 18px 48px;max-width:1500px;margin:0 auto}.ao-alert{border-radius:14px;padding:12px 15px;margin-bottom:14px;font-weight:700}.ao-alert.success{background:#ecfdf3;color:#166534}.ao-alert.error{background:#fff1f2;color:#991b1b}.ao-tabs{display:inline-flex;background:#fff;border:1px solid var(--ao-border);border-radius:999px;padding:5px;gap:4px;margin-bottom:18px}.ao-tab{display:inline-flex;align-items:center;gap:7px;padding:9px 15px;border-radius:999px;text-decoration:none;color:#667085;font-size:12px;font-weight:900}.ao-tab.active{background:var(--ao-red);color:#fff;box-shadow:0 8px 22px rgba(243,40,44,.24)}
...
<div class="ao-portal">
    <aside class="ao-side" id="aoPortalSidebar">
        <a class="ao-side-logo" href="{{ route('em.customer.index') }}"><img src="{{ asset('images/logo.png') }}" alt="Alcatraz Outlaws"></a>
            ...
            <div class="d-flex align-items-center gap-2 ms-auto">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end ao-dropdown">
                        <a class="dropdown-item" href="{{ route('em.customer.dashboard') }}"><i class="fa-solid fa-house me-2" style="color:#f3282c"></i>Dashboard</a>
                        <a class="dropdown-item" href="{{ route('em.customer.profile') }}"><i class="fa-regular fa-user me-2" style="color:#f3282c"></i>Profile</a>
