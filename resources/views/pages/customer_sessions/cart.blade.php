...
@section('title', 'Training Cart | Alcatraz Outlaws')
...
<style>
:root{--ao-red:#f3282c;--ao-soft:#fff1f1;--ao-black:#080808;--ao-bg:#f5f6f8;--ao-border:#e7e9ee;--ao-muted:#687083}
.training-cart-page{min-height:calc(100vh - 104px);background:var(--ao-bg);padding:30px 0 60px;font-family:'Raleway',sans-serif;color:#111}.training-cart-shell{width:min(1120px,calc(100% - 32px));margin:0 auto}.training-cart-grid{display:grid;grid-template-columns:minmax(0,1fr) 320px;gap:24px;align-items:start}.training-cart-list{display:flex;flex-direction:column;gap:18px}.training-cart-card{background:#fff;border:1px solid #dfe2e7;border-radius:28px;box-shadow:0 14px 30px rgba(0,0,0,.055);padding:22px}.training-cart-card-head{display:flex;justify-content:space-between;align-items:flex-start;gap:20px}.training-cart-badge{display:inline-flex;align-items:center;border-radius:999px;background:var(--ao-soft);color:var(--ao-red);font-size:11px;font-weight:900;padding:7px 11px}.training-cart-title{margin:10px 0 0;font-family:'Archivo Black',sans-serif;font-size:25px;letter-spacing:-.04em}.training-cart-line-label{color:#677084;font-size:10px;font-weight:900;text-transform:uppercase;letter-spacing:.13em;text-align:right}.training-cart-line-total{margin-top:4px;color:var(--ao-red);font-size:29px;line-height:1;font-weight:500}.training-session-box{margin-top:18px;border:1px solid rgba(243,40,44,.24);background:linear-gradient(135deg,#fff7f7,#fff);border-radius:20px;padding:15px}.training-session-kicker{color:#6e7688;font-size:10px;font-weight:900;text-transform:uppercase;letter-spacing:.18em}.training-session-title{margin:4px 0 10px;font-size:19px;font-weight:500}.training-session-meta{display:flex;flex-wrap:wrap;gap:7px}.training-session-pill{display:inline-flex;align-items:center;gap:6px;max-width:100%;border:1px solid #eceef2;border-radius:999px;background:#fff;padding:7px 10px;color:#252a34;font-size:10px;font-weight:800;text-decoration:none}.training-session-pill i{color:var(--ao-red)}.training-what{margin-top:11px;border:1px solid #eceef2;border-radius:13px;background:#fff;padding:11px}.training-what span{display:block;color:#687083;font-size:9px;font-weight:900;letter-spacing:.16em;text-transform:uppercase}.training-what strong{display:block;margin-top:6px;font-size:11px}.training-cart-card-footer{display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;border-top:1px solid #eceef2;margin-top:16px;padding-top:15px}.training-cancel{display:inline-flex;align-items:center;gap:7px;border:0;background:none;color:#db1f24;font-weight:900;font-size:12px}.training-qty{display:flex;align-items:center;gap:8px}.training-qty input{width:72px;height:38px;border:1px solid #d9dde4;border-radius:10px;padding:0 10px}.training-qty button{height:38px;border:1px solid #111;border-radius:999px;background:#fff;padding:0 13px;font-weight:900;font-size:11px}.training-summary{position:sticky;top:126px;background:#fff;border:1px solid #dfe2e7;border-radius:28px;box-shadow:0 18px 34px rgba(0,0,0,.10);padding:23px}.training-summary h2{margin:0 0 18px;font-size:25px;font-weight:500}.training-summary-row{display:flex;justify-content:space-between;gap:18px;padding:8px 0;color:#5d6472;font-size:12px;font-weight:800}.training-summary-row strong{color:#4b515c}.training-summary hr{border:0;border-top:1px solid #dfe2e7;margin:10px 0}.training-summary-total{display:flex;justify-content:space-between;align-items:flex-end;gap:18px;border-top:1px solid #dfe2e7;margin-top:8px;padding-top:20px}.training-summary-total span{font-size:16px;font-weight:900}.training-summary-total strong{color:var(--ao-red);font-size:30px;font-weight:500}.training-primary,.training-secondary{width:100%;min-height:44px;border-radius:999px;display:flex;align-items:center;justify-content:center;gap:8px;text-decoration:none;font-size:12px;font-weight:900}.training-primary{margin-top:19px;background:var(--ao-red);color:#fff;box-shadow:0 12px 24px rgba(243,40,44,.24)}.training-primary:hover{color:#fff;background:#d91f24}.training-secondary{margin-top:9px;border:1.5px solid #111;background:#fff;color:#111}.training-secondary:hover{background:#111;color:#fff}.training-cart-empty{background:#fff;border:1px dashed #cfd3da;border-radius:28px;padding:50px 20px;text-align:center}.training-cart-empty i{font-size:38px;color:var(--ao-red)}.training-cart-empty h2{margin-top:14px;font-family:'Archivo Black',sans-serif;font-size:25px}.training-cart-alert{margin-bottom:18px;border-radius:16px;padding:13px 16px;font-weight:800;font-size:12px}.training-cart-alert.success{background:#ecfdf3;color:#166534}.training-cart-alert.error{background:#fff1f2;color:#b42318}@media(max-width:900px){.training-cart-grid{grid-template-columns:1fr}.training-summary{position:static}}@media(max-width:600px){.training-cart-page{padding-top:18px}.training-cart-shell{width:min(100% - 20px,1120px)}.training-cart-card,.training-summary{border-radius:20px;padding:17px}.training-cart-card-head{flex-direction:column}.training-cart-line-label,.training-cart-line-total{text-align:left}.training-cart-title{font-size:22px}}
</style>
                        ...
                        @if($isBookingItem && $session)
                            <div class="training-session-box">
                                ...
                                @if(trim((string)($session->what_to_bring ?? '')) !== '')
                                    <div class="training-what"><span>What to Bring</span><strong><i class="fa-solid fa-gift me-1" style="color:#f3282c"></i>{{ $session->what_to_bring }}</strong></div>
                                @endif
                            </div>
                        @endif
