...
@section('content')
<style>
.schedule-page{--a:#f3282c;--ad:#d91f23;--soft:#fff0f0}.schedule-top{display:flex;justify-content:space-between;align-items:flex-start;gap:16px;flex-wrap:wrap;margin-bottom:18px}.schedule-top h2{font-weight:900;margin:0}.schedule-top p{color:#64748b;margin:6px 0 0}.schedule-card{background:#fff;border:1px solid #e2e8f0;border-radius:18px;padding:20px}.schedule-filter{display:grid;grid-template-columns:2fr 1fr 1fr auto auto;gap:12px;align-items:end;background:linear-gradient(135deg,#fff,#fff7f7);border:1px solid #f5c7c8;border-radius:18px;padding:14px;margin-bottom:20px}.s-label{font-size:11px;font-weight:900;text-transform:uppercase;color:#556070;margin-bottom:6px}.s-input{height:40px;border-radius:999px;border:1px solid #d8dee8;padding:0 14px;width:100%}.s-input:focus{outline:0;border-color:var(--a);box-shadow:0 0 0 3px rgba(243,40,44,.1)}.s-btn{height:40px;border-radius:999px;font-weight:900;padding:0 18px}.package-list{display:flex;flex-direction:column;gap:10px}.package-row{display:flex;justify-content:space-between;gap:16px;align-items:center;border:1px solid #dfe5ed;border-radius:15px;padding:16px}.package-row:hover{border-color:var(--a);box-shadow:0 10px 24px rgba(243,40,44,.08)}.package-row h4{font-size:17px;font-weight:900;margin:0}.pill{display:inline-flex;background:var(--soft);color:var(--a);border-radius:999px;padding:6px 10px;font-size:11px;font-weight:900;margin:8px 6px 0 0}.pill.user{background:#eef4ff;color:#3448a4}.pill.guest{background:#fff0f0;color:#d91f23}.round-icon{width:36px;height:36px;border:0;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;background:#f8fafc}.round-icon:hover{background:var(--soft);color:var(--a)}@media(max-width:900px){.schedule-filter{grid-template-columns:1fr 1fr}.package-row{align-items:flex-start}}@media(max-width:575px){.schedule-filter{grid-template-columns:1fr}.package-row{flex-direction:column}.s-btn{width:100%}}
</style>
<div class="schedule-page">
    <div class="schedule-top"><div><h2>Packages</h2><p>Create and manage separate Training prices for admin-added Users and online Guests.</p></div><div class="d-flex align-items-center gap-2"><span class="badge rounded-pill text-bg-light text-primary px-3 py-2"><i class="fa-solid fa-box-open me-1"></i>{{ $packages->total() }} Packages</span><a href="{{ route('admin.em.packages.create') }}" class="btn btn-primary rounded-pill fw-bold px-4"><i class="fa-solid fa-plus me-2"></i>Add Package</a></div></div>
